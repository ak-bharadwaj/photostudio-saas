    ...
    <div className="min-h-screen relative flex items-center justify-center p-6 bg-background selection:bg-amber-500/20 selection:text-amber-900 transition-colors duration-1000">
        ...
        <div className="relative z-10 w-full max-w-[440px] animate-luxury-in">
            ...
            <div className="bg-surface-1/80 backdrop-blur-3xl border border-border p-8 sm:p-12 shadow-expensive rounded-[40px] relative overflow-hidden group">
                ...
                <div className="space-y-6">
                    <button
                        ...
                        className="w-full h-14 flex items-center justify-center gap-3 bg-white border border-border text-[11px] font-black uppercase tracking-widest transition-all hover:bg-foreground hover:text-white hover:border-foreground rounded-2xl group shadow-sm hover:shadow-xl"
                    >
                    ...
                    {error && (
                        <div className="p-4 bg-red-500/10 border border-red-500/20 text-red-500 text-[10px] font-black uppercase tracking-widest text-center rounded-xl animate-shake">
                ...
                <div className="mt-10 pt-8 border-t border-border/50 text-center">
                    <p className="text-[10px] font-black tracking-[0.2em] text-foreground/20 uppercase mb-4">
                        Are you a Partner?
                    </p>
                    <Link 
                        href="/login" 
                        className="inline-flex items-center gap-2 text-[10px] font-black uppercase tracking-[0.2em] text-amber-600/70 hover:text-amber-600 transition-colors"
                    >
            ...
            <div className="mt-12 text-center opacity-30 select-none">
                 <p className="text-[10px] font-black tracking-[.4em] uppercase text-foreground italic">
