            ...
            <div className="bg-surface-1/80 backdrop-blur-3xl border border-border p-8 sm:p-12 shadow-expensive rounded-[40px] relative overflow-hidden group">
                ...
                <div className="space-y-6">
                    <button
                        ...
                        className="w-full h-14 flex items-center justify-center gap-3 bg-surface-0 border border-border text-[11px] font-bold uppercase tracking-widest transition-all hover:bg-foreground hover:text-background hover:border-foreground rounded-2xl group"
                    >
